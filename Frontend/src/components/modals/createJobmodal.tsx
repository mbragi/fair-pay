  ...
  <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
   <div className="bg-white rounded-lg p-8 max-w-lg w-full">
    ...
    <form onSubmit={handleSubmit}>
     ...
     {useCustomToken && (
      <div className="mb-4">
       <label className="block text-gray-700 mb-2">Custom Token Address</label>
       <input
        type="text"
        className="w-full p-2 border rounded"
        value={tokenAddress}
     ...
     <div className="flex justify-end">
      ...
      <button
       type="submit"
       disabled={isSubmitting}
       className={`px-4 py-2 rounded text-white ${isSubmitting ? "bg-indigo-400 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700"
        }`}
      >
       {isSubmitting ? (
