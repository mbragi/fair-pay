// components/job/CreateJobModal.tsx
...
const CreateJobModal: React.FC<Props> = ({
  ...
  // Use the constant from contracts.ts instead of hardcoding the address
  // This improves maintainability as all contract addresses are centralized
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onCreate({
        ...
        payment,
        milestoneCount,
        tokenAddress: useCustomToken ? tokenAddress : WBBT_TOKEN_ADDRESS,
      });
      // reset
      setTitle("");
      setDescription("");
